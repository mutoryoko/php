    ...
    <main>
        <div class="result__content">
            <div class="result-cards">
                <div class="result-card tokyo">
                    <div class="result-card__img-wrapper">
                        <img class="result-card__img" src="img/<?php echo $tokyo['img'] ?>" alt="国旗">
                    </div>
                    <div class="result-card__body">
                        <p class="result__city"><?php echo $tokyo['name'] ?></p>
                        <p class="result__time"><?php echo $tokyo['time'] ?></p>
                    </div>
                </div>
                <div class="result-card comparison">
                    ...
                    <div class="result-card__body">
                        <p class="result__city"><?php echo $comparison['name'] ?></p>
                        <p class="result__time"><?php echo $comparison['time'] ?></p>
                    </div>
                </div>
            </div>
        </div>
